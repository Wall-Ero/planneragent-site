...
export type CockpitPlanPresentationStateV1 = "VALID" | "MISSING" | "BROKEN";
...
export type CockpitSignalAssertabilityV1 = Readonly<{
  ...
  plan_presentation_state?: CockpitPlanPresentationStateV1;
...
export function manifestCockpitPlanStateV1(state:"COHERENT"|"SOME_GAPS"|"INCOHERENT"):CockpitPlanPresentationStateV1{return state==="COHERENT"?"VALID":state==="SOME_GAPS"?"MISSING":"BROKEN"}
