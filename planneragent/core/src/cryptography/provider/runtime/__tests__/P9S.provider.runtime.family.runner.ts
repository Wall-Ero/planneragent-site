// ============================================================
// PlannerAgent — Provider Runtime Ledger Integrity / Audit Admission Family Runner
// ============================================================
//
// PATH
// ------------------------------------------------------------
// core/src/cryptography/provider/runtime/__tests__/
// P9S.provider.runtime.family.runner.ts
//
// STATUS
// ------------------------------------------------------------
...
// DOMAIN
// ------------------------------------------------------------
// P9S — Provider Runtime Ledger Integrity / Audit Admission Family Runner
//
// PURPOSE
// ------------------------------------------------------------
// Verify the complete P9S provider-runtime
// ledger-integrity and audit-admission family.
//
// Chain verified:
//
// P9R writes one durable provider-runtime ledger fact.
// ↓
// P9S validates durable identity and lineage coherence.
// ↓
// P9S admits that fact into the governed audit domain.
// ↓
// Audit execution remains outside P9S.
//
...
function main(): void {
  ...
  console.log("");
  console.log("========================================");
  console.log("P9S PROVIDER RUNTIME FAMILY");
  console.log("========================================");
  console.log("");
  ...
  console.log("");
  console.log("========================================");
  console.log("P9S PROVIDER RUNTIME FAMILY VERIFIED");
