...
// P9T.provider.runtime.family.runner.ts
//
// STATUS
// ------------------------------------------------------------
...
// DOMAIN
// ------------------------------------------------------------
// P9T — Provider Runtime Family Runner
//
// PURPOSE
// ------------------------------------------------------------
// Verify the complete P9T provider-runtime audit family boundary
// across governed audit execution, finding semantics, canonical
// audit-record composition, durable claims, lineage, and isolation.
//
...
function main(): void {
  ...
  console.log("");
  console.log("========================================");
  console.log("P9T PROVIDER RUNTIME FAMILY");
  console.log("========================================");
  console.log("");
  ...
  console.log("");
  console.log("========================================");
  console.log("P9T PROVIDER RUNTIME FAMILY VERIFIED");
