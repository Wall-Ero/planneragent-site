...
export interface Env {
  ...
  INTERPRETATION_STUDENT_SHADOW_ENABLED?: string;
  ...
  INTERPRETATION_STUDENT_SHADOW_STATE?: string;
  INTERPRETATION_STUDENT_SAMPLE_PERCENT?: string;
  INTERPRETATION_STUDENT_KILL_SWITCH?: string;
  INTERPRETATION_STUDENT_WINDOW_ID?: string;
  INTERPRETATION_STUDENT_ENDPOINT_REFERENCE?: string;
  INTERPRETATION_STUDENT_CREDENTIAL_REFERENCE?: string;
  DL_ENABLED?: string;
